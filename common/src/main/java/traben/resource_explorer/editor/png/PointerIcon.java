...
enum PointerIcon {
    BRUSH() {
        ...
        void render(DrawContext context, int mouseX, int mouseY, int color) {
            ...
            context.drawTexture(Identifier.of(MOD_ID, "textures/pointer_brush_handle.png"),
        ...
        void drawTexturedQuad(int color, DrawContext context, Identifier texture, int x1, int x2, int y1, int y2, float u1, float u2, float v1, float v2) {
            ...
            bufferBuilder.vertex(matrix4f, (float) x1, (float) y1, 0).color(b, g, r, a).texture(u1, v1);
            bufferBuilder.vertex(matrix4f, (float) x1, (float) y2, 0).color(b, g, r, a).texture(u1, v2);
            bufferBuilder.vertex(matrix4f, (float) x2, (float) y2, 0).color(b, g, r, a).texture(u2, v2);
            bufferBuilder.vertex(matrix4f, (float) x2, (float) y1, 0).color(b, g, r, a).texture(u2, v1);
    ...
    HAND_MOVE() {
        @Override
        void render(DrawContext context, int mouseX, int mouseY, int color) {
            context.drawTexture(Identifier.of(MOD_ID, "textures/pointer_move.png"),
    ...
    ERASER() {
        @Override
        void render(DrawContext context, int mouseX, int mouseY, int color) {
            context.drawTexture(Identifier.of(MOD_ID, "textures/pointer_rubber.png"),
    ...
    PICK() {
        @Override
        void render(DrawContext context, int mouseX, int mouseY, int color) {
            context.drawTexture(Identifier.of(MOD_ID, "textures/pointer_pick.png"),
                    mouseX, mouseY - 16, 0.0F, 0.0F, 16, 16, 16, 16);
        }
    };
